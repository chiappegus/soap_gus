...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/soap')) {
            ...
            // api_req
            if ('/soap/api_req' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\SoapController::api',  '_route' => 'api_req',);
            }
        ...
        // app_soap_api
        if ('' === $trimmedPathinfo) {
            $ret = array (  '_controller' => 'AppBundle\\Controller\\SoapController::api',  '_route' => 'app_soap_api',);
            if ('/' === substr($pathinfo, -1)) {
                // no-op
            } elseif ('GET' !== $canonicalMethod) {
                goto not_app_soap_api;
            } else {
                return array_replace($ret, $this->redirect($rawPathinfo.'/', 'app_soap_api'));
            }
